...
public:
    ...
    // 同生共死
    static Skill* createSharedFate() {
        return new Skill("同生共死", "与敌人共享40%伤害", 
    ...
    // 欺诈
    static Skill* createFoulPlay() {
        return new Skill("欺诈", "使用敌人的攻击力进行攻击", 
                        SkillType::FOUL_PLAY, SkillRarity::EPIC);
    }
